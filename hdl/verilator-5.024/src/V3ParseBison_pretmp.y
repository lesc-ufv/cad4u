...
%type<caseItemp>	 c_case_generate_item c_case_generate_itemList c_case_generate_itemListE case_generate_item case_generate_itemList case_generate_itemListE case_insideListE case_inside_itemList case_itemList case_itemListE case_patternListE property_case_item property_case_itemList rand_case_itemList
...
finc_or_dec_expression:  // ==IEEE: inc_or_dec_expression
                                 fexprScope yP_PLUSPLUS                         { $<fl>$ = $<fl>1; $$ = new AstPostAdd{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       fexprScope yP_MINUSMINUS                         { $<fl>$ = $<fl>1; $$ = new AstPostSub{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       yP_PLUSPLUS     expr                         { $<fl>$ = $<fl>1; $$ = new AstPreAdd{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         |       yP_MINUSMINUS   expr                         { $<fl>$ = $<fl>1; $$ = new AstPreSub{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         // {copied}
        ;

sinc_or_dec_expression:  // IEEE: inc_or_dec_expression (for sequence_expression)
                                 sexprScope yP_PLUSPLUS                         { $<fl>$ = $<fl>1; $$ = new AstPostAdd{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       sexprScope yP_MINUSMINUS                         { $<fl>$ = $<fl>1; $$ = new AstPostSub{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       yP_PLUSPLUS     expr                         { $<fl>$ = $<fl>1; $$ = new AstPreAdd{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         |       yP_MINUSMINUS   expr                         { $<fl>$ = $<fl>1; $$ = new AstPreSub{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         // {copied}
        ;

pinc_or_dec_expression:  // IEEE: inc_or_dec_expression (for property_expression)
                                 pexprScope yP_PLUSPLUS                         { $<fl>$ = $<fl>1; $$ = new AstPostAdd{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       pexprScope yP_MINUSMINUS                         { $<fl>$ = $<fl>1; $$ = new AstPostSub{$2, new AstConst{$2, AstConst::StringToParse{}, "'b1"},                                                                $1, $1->cloneTreePure(true)}; }         |       yP_PLUSPLUS     expr                         { $<fl>$ = $<fl>1; $$ = new AstPreAdd{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         |       yP_MINUSMINUS   expr                         { $<fl>$ = $<fl>1; $$ = new AstPreSub{$1, new AstConst{$1, AstConst::StringToParse{}, "'b1"},                                                               $2, $2->cloneTreePure(true)}; }         // {copied}
        ;
...
expr:                // IEEE: part of expression/constant_expression/primary
        ...
        |       expr '.' function_subroutine_callNoMethod '[' expr ']'
                        { $$ = new AstSelBit{$4, new AstDot{$2, false, $1, $3}, $5}; }
        |       expr '.' function_subroutine_callNoMethod '[' constExpr ':' constExpr ']'
                        { $$ = new AstSelExtract{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        |       expr '.' function_subroutine_callNoMethod '[' expr yP_PLUSCOLON constExpr ']'
                        { $$ = new AstSelPlus{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        |       expr '.' function_subroutine_callNoMethod '[' expr yP_MINUSCOLON constExpr ']'
                        { $$ = new AstSelMinus{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        //                      // method_call:array_method requires a '.'
        |       expr '.' array_methodWith
                        { $$ = new AstDot{$2, false, $1, $3}; }
        |       expr '.' array_methodWith '[' expr ']'
                        { $$ = new AstSelBit{$4, new AstDot{$2, false, $1, $3}, $5}; }
        |       expr '.' array_methodWith '[' constExpr ':' constExpr ']'
                        { $$ = new AstSelExtract{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        |       expr '.' array_methodWith '[' expr yP_PLUSCOLON constExpr ']'
                        { $$ = new AstSelPlus{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        |       expr '.' array_methodWith '[' expr yP_MINUSCOLON constExpr ']'
                        { $$ = new AstSelMinus{$4, new AstDot{$2, false, $1, $3}, $5, $7}; }
        //
        //                      // IEEE: let_expression
        //                      // see funcRef
